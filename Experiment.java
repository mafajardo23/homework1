    ...
    public static void main(String[] args) {
        ...
        for (int d :simulationProblems.keySet()) {
            ...
            for (int[] board : boards) {
                ...
                bFactorh4 += PuzzleBoard.bFactor(result4.nodesGenerated, result4.depth);
